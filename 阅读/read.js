 ...
 * 感谢所有测试人员 
 * ========= 青龙 =========
 * 变量格式: export read_data='token1 @ token2'  多个账号用 @分割
 *
 ...
 */
async function userInfo1(timeout = 3 * 1000) {
	...
	if (result.code == 1) {
		...
		console.log(`\n 阅读:${result.msg} , 喂 , 喂  喂 ---  登录过期了,别睡了, 起来更新了喂!\n`);
		console.log(`\n 阅读:${result.msg} , 喂 , 喂  喂 ---  登录过期了,别睡了, 起来更新了喂!\n`);
