...
1668649645-rQbjnR7GU9APk6EHNOmFr5FowzZHjzZT6J9RQlbbwhA=
...
// 登录   httpPost
// https://api.hinan8.com/api/PlayerVue/Login?b8ef038bdc27fc47a5087ce0f63e7622=1668649537-a5ffb67ffa2e42483898949bc485fafe0c8a-0-07401e849c03c7e6f0011cdfa67243b7&auth_key=1668649537-AzTNIoqyOjQfSkRBIwPN1Dawjo8qZLnPZ0tgF0lZp4Y%3D
async function login(name) {
    ...
    try {
        ...
        if (result.code == 200) {
            phone = result.data.User;
            Token = result.data.Token;
            await user_info('用户信息');
            DoubleLog(`${name}: ${result.msg} ,欢迎 ${phone_num(phone)} ,可提现余额 ${freedAccount}`);
            await wait(3);
        } else {
...
// 用户信息 	httpGet  https://api.hinan8.com/api/Minmetals/postUserInfo?b8ef038bdc27fc47a5087ce0f63e7622=1663874152-2e35ecd83f79cb4ad6c846155ea56a2ca34a-0-d8dc209897d241987fb879a132619e9c
async function user_info(name) {
    ...
    try {
        ...
        // console.log(result);
        if (result.code == 200) {
            freedAccount = result.data.freedAccount;
            return freedAccount;
        } else {
            DoubleLog(`${name}: 失败❌了呢`);
            console.log(result);
