...
http://niunaiyouxuan.bnmbggg.top:1003/			邀请码 88767832  40921855 
...
class UserInfo {
    ...
    async init(name) {
        let options = {
            method: "get",
            url: `http://niunaiyouxuan.bnmbggg.top:1003/login.html?login=1`,
            headers: {
                "Pragma": "no-cache",
    ...
    async login(name) {
        let options = {
            method: "Post",
            url: `http://niunaiyouxuan.bnmbggg.top:1003/login.html`,
            headers: {
    ...
    async userindex(name) {
        let options = {
            method: "get",
            url: `http://niunaiyouxuan.bnmbggg.top:1003/user/withdraw.html`,
            headers: {
                'Cookie': this.y
            },
        };
    ...
    async user_info(name) {
        let options = {
            method: "get",
            url: `http://niunaiyouxuan.bnmbggg.top:1003/user/index.html`,
            headers: {
                'Cookie': this.y
            },
        };
        ...
        if (result) {
            ...
            // console.log('this.urer_name',this.urer_name)
        }
    ...
    async lottery(name) {
        let options = {
            method: "get",
            url: `http://niunaiyouxuan.bnmbggg.top:1003/user/wheel/click`,
            headers: {
                'Cookie': this.y
            },
        };
