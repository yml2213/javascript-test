...
-------------------  青龙-配置文件-复制区域  -------------------
# 曙辉产业
export shuhui=" phone # pwd @ phone # pwd "  
...
class UserClass {
    ...
    async checkLogin() { // 登录  
        let options = {
            fn: '登录',
            method: 'post',
            url: `https://shuhuidc.com/index/account/login.html`,
            headers: {
    ...
    async signin() { // 签到
        let options = {
            fn: '签到',
            method: 'get',
            url: `https://shuhuidc.com/handle/signup`,
            headers: {
                'X-Requested-With': 'XMLHttpRequest',
                'Cookie': this.cookie,
                'User-Agent': 'Mozilla/5.0 (Linux; Android 12; M2102J2SC Build/SKQ1.211006.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/96.0.4664.104 Mobile Safari/537.36 uni-app Html5Plus/1.0 (Immersed/32.727272)',
    ...
    async check() { // 余额查询
        let options = {
            fn: '余额查询',
            method: 'get',
            url: `https://shuhuidc.com/index/member/person.html`,
            headers: {
