 ...
 */
 function signin(timeout = 3 * 1000) {
	return new Promise((resolve) => {
		let url = {
			url: `http://www.zeguoren.com/plugin.php?id=it618_credits:ajax&formhash=4c2b895b&ac=qd`,    // 这是请求的 url 可以直接用我们抓包、精简后的URL
			headers: {            // headers 是请求体  可以直接用精简后的 hd  也就是服务器校验的部分，他需要啥，我们就给他啥  
				...
				"User-Agent":"Mozilla/5.0 (iPhone; CPU iPhone OS 13_5_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0.3 Mobile/15E148 Safari/604.1",
			},
		}
