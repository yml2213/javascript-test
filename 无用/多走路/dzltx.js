...
2-16  第一版  视频宝箱测试中（每天6个）

入口: AppStore下载  多走路

注意事项 ： 一定要仔细阅读一下内容
=============青龙变量格式=============
export yml_dzl_data='xxx & xxx & xxx & xxx @ xxx & xxx & xxx & xxx '
ApiAuthKey & token & ApiAuthTime & body   多账号使用 @ 分割
=============青龙变量实例=============
yml_dzl_data='7e843d4368916aa8c61dd65407612cf2&1644939716562&{"extra": "{\"position_code\":\"CL8386745\"}"}'
=============变量解释==========
ApiAuthKey ,  token , ApiAuthTime , body(body就是json主体)  可以从 关键词 reward/videoNotify 包里找到,注意对应关系
=============变量获取==========
懒得写了，自己研究吧
...
!(async () => {
    ...
    for (i = 0; i < app_yml_dzl_data.length; i++) {
        ...
        token = app_yml_dzl_data[i].split('&');
