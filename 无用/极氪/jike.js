/**
 * 脚本地址: https://raw.githubusercontent.com/yml2213/javascript/master/jike/jike.js
 * 转载请留信息,谢谢
 *
 * 极氪  app 
 *
 * cron 10 7,12 * * *  yml2213_javascript_master/jike.js
 *
 * 6-9		基本完成所有任务
 *
 * 感谢所有测试人员
 * ========= 青龙--配置文件 =========
 * 变量格式: export jike_data='token @ token'  多个账号用 换行 或 @分割
 *
...
///////////////////////////////////////////////////////////////////
let ckStr = process.env.jike_data;
let msg = "";
let ck = "";
let host = "mgw.mpaas.cn-hangzhou.aliyuncs.com";
...
async function tips(ckArr) {
	let Version_latest = await Version_Check('jike');
...
!(async () => {
	let ckArr = await getCks(ckStr, "jike_data");
	await tips(ckArr);
...
/**
 * 签到    httpPost
 * https://mgw.mpaas.cn-hangzhou.aliyuncs.com/mgw.htm
 */
...
/**
 * 获取远程版本
 * http://yml-gitea.ml:2233/yml/JavaScript-yml/raw/branch/master/jike.js
 */
