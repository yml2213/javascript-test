...
`)}isNode(){return"undefined"!=typeof module&&!!module.exports}isQuanX(){return"undefined"!=typeof $task}isSurge(){return"undefined"!=typeof $httpClient&&"undefined"==typeof $loon}isLoon(){return"undefined"!=typeof $loon}getdata(e){let s=this.getval(e);if(/^@/.test(e)){let[,i,r]=/^@(.*?)\.(.*?)$/.exec(e),n=i?this.getval(i):"";if(n)try{let o=JSON.parse(n);s=o?this.lodash_get(o,r,""):s}catch(l){s=""}}return s}setdata(e,s){let i=!1;if(/^@/.test(s)){let[,r,n]=/^@(.*?)\.(.*?)$/.exec(s),o=this.getval(r);try{let l=JSON.parse(r?"null"===o?null:o||"{}":"{}");this.lodash_set(l,n,e),i=this.setval(JSON.stringify(l),r)}catch(a){let h={};this.lodash_set(h,n,e),i=this.setval(JSON.stringify(h),r)}}else i=this.setval(e,s);return i}getval(e){return this.isSurge()||this.isLoon()?$persistentStore.read(e):this.isQuanX()?$prefs.valueForKey(e):this.isNode()?(this.data=this.loaddata(),this.data[e]):this.data&&this.data[e]||null}setval(e,s){return this.isSurge()||this.isLoon()?$persistentStore.write(e,s):this.isQuanX()?$prefs.setValueForKey(e,s):this.isNode()?(this.data=this.loaddata(),this.data[s]=e,this.writedata(),!0):this.data&&this.data[s]||null}send(e,s,i=()=>{}){if("get"!=e&&"post"!=e&&"put"!=e&&"delete"!=e){console.log(`无效的http方法：${e}`);return}if("get"==e&&s.headers?(delete s.headers["Content-Type"],delete s.headers["Content-Length"]):s.body&&s.headers&&!s.headers["Content-Type"]&&(s.headers["Content-Type"]="application/x-www-form-urlencoded"),this.isSurge()||this.isLoon()){this.isSurge()&&this.isNeedRewrite&&(s.headers=s.headers||{},Object.assign(s.headers,{"X-Surge-Skip-Scripting":!1}));let r={method:e,url:s.url,headers:s.headers,timeout:s.timeout,data:s.body};"get"==e&&delete r.data,$axios(r).then(e=>{let{status:s,request:r,headers:n,data:o}=e;i(null,r,{statusCode:s,headers:n,body:o})}).catch(e=>console.log(e))}else if(this.isQuanX())s.method=e.toUpperCase(),this.isNeedRewrite&&(s.opts=s.opts||{},Object.assign(s.opts,{hints:!1})),$task.fetch(s).then(e=>{let{statusCode:s,request:r,headers:n,body:o}=e;i(null,r,{statusCode:s,headers:n,body:o})},e=>i(e));else if(this.isNode()){this.got=this.got?this.got:require("got");let{url:n,...o}=s;this.instance=this.got.extend({followRedirect:!1}),this.instance[e](n,o).then(e=>{let{statusCode:s,request:r,headers:n,body:o}=e;i(null,r,{statusCode:s,headers:n,body:o})},e=>{let{message:s,request:r,response:n}=e;i(s,r,n)})}}time(e,s=null){let i=s?new Date(s):new Date,r={"M+":i.getMonth()+1,"d+":i.getDate(),"h+":i.getHours(),"m+":i.getMinutes(),"s+":i.getSeconds(),"q+":Math.floor((i.getMonth()+3)/3),S:i.getMilliseconds()};for(let n in/(y+)/.test(e)&&(e=e.replace(RegExp.$1,(i.getFullYear()+"").substr(4-RegExp.$1.length))),r)RegExp("("+n+")").test(e)&&(e=e.replace(RegExp.$1,1==RegExp.$1.length?r[n]:("00"+r[n]).substr((""+r[n]).length)));return e}async showmsg(){if(!this.notifyStr)return;let e=this.name+" 运行通知\n\n"+this.notifyStr;if($.isNode()){var s=require("./sendNotify");console.log("\n============== 推送 =============="),await s.sendNotify(this.name,e)}else this.msg(e)}logAndNotify(e){console.log(e),this.notifyStr+=e,this.notifyStr+="\n"}logAndNotifyWithTime(e){let s="["+this.time("hh:mm:ss.S")+"]"+e;console.log(s),this.notifyStr+=s,this.notifyStr+="\n"}logWithTime(e){console.log("["+this.time("hh:mm:ss.S")+"]"+e)}msg(e=t,s="",i="",r){let n=e=>{if(!e)return e;if("string"==typeof e)return this.isLoon()?e:this.isQuanX()?{"open-url":e}:this.isSurge()?{url:e}:void 0;if("object"==typeof e){if(this.isLoon()){let s;return{openUrl:e.openUrl||e.url||e["open-url"],mediaUrl:e.mediaUrl||e["media-url"]}}if(this.isQuanX()){let i;return{"open-url":e["open-url"]||e.url||e.openUrl,"media-url":e["media-url"]||e.mediaUrl}}if(this.isSurge())return{url:e.url||e.openUrl||e["open-url"]}}};this.isMute||(this.isSurge()||this.isLoon()?$notification.post(e,s,i,n(r)):this.isQuanX()&&$notify(e,s,i,n(r)));let o=["","============== 系统通知 =============="];o.push(e),s&&o.push(s),i&&o.push(i),console.log(o.join("\n"))}getMin(e,s){return e<s?e:s}getMax(e,s){return e<s?s:e}padStr(e,s,i="0"){let r=String(e),n=s>r.length?s-r.length:0,o="";for(let l=0;l<n;l++)o+=i;return o+r}json2str(e,s,i=!1){let r=[];for(let n of Object.keys(e).sort()){let o=e[n];o&&i&&(o=encodeURIComponent(o)),r.push(n+"="+o)}return r.join(s)}str2json(e,s=!1){let i={};for(let r of e.split("&")){if(!r)continue;let n=r.indexOf("=");if(-1==n)continue;let o=r.substr(0,n),l=r.substr(n+1);s&&(l=decodeURIComponent(l)),i[o]=l}return i}randomPattern(e,s="abcdef0123456789"){let i="";for(let r of e)"x"==r?i+=s.charAt(Math.floor(Math.random()*s.length)):"X"==r?i+=s.charAt(Math.floor(Math.random()*s.length)).toUpperCase():i+=r;return i}randomString(e,s="abcdef0123456789"){let i="";for(let r=0;r<e;r++)i+=s.charAt(Math.floor(Math.random()*s.length));return i}randomList(e){return e[Math.floor(Math.random()*e.length)]}wait(e){return new Promise(s=>setTimeout(s,e))}done(e={}){let s=(new Date).getTime(),i=(s-this.startTime)/1e3;console.log(`
