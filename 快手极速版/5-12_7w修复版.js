...
class _0x9d8dda {
	constructor(T) {
		...
		this["cookie"] = "kpn=NEBULA; kpf=ANDROID_PHONE; did=ANDROID_841582594efb574a; ver=9.10; appver=9.10.40.2474; language=zh-cn; countryCode=CN; sys=ANDROID_5.1; client_key=2ac2a76d; " + p;
...
async function _0x505e51() {
	const c = {
		'url': "https://ziye0.coding.net/p/ziye/d/ql/git/raw/master/ks.json",
		'headers': ''
	};
	await _0x39a23b("get", c);
	let p = _0x1a0963;
