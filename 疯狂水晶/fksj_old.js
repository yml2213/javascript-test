 ...
 * cron 10 8,12,18 * * *  yml2213_javascript_master/fksj.js
 * 
 * 疯狂水晶 app  
 * 4-26 完成 签到 , 观看视频 , 京喜红包 任务   有bug及时反馈
 * 4-26 更新随机时间间隔
 * 4-28	增加 一键收矿石 跟 升级 功能 (一键收矿石 默认关闭,有资格的自行抓包删除注释即可启用,详情自己看官方介绍)
 * 
 * 感谢所有测试人员
 * ========= 青龙 =========
 * 变量格式: export fksj_data=' 签到 # 观看视频 # 京喜红包  # 升级 # 一键收矿石 @ 签到 # 观看视频 # 京喜红包  # 升级 # 一键收矿石 '  多个账号用 @分割 
 ...
 */
 ...
 async function tips(ckArr) {
     console.log(`\n本地脚本4-28`)
     // console.log(`\n 脚本已恢复正常状态,请及时更新! `);
     console.log(`\n 求助前请打开 23 行左右的 debug 运行一次,再发日志求助 \n`)
     console.log(`\n 脚本测试中,有bug及时反馈! \n`)
     console.log(`\n 脚本测试中,有bug及时反馈! \n`)
     console.log(`\n 脚本测试中,有bug及时反馈! \n`)
 ...
 async function signin(timeout = 3 * 1000) {
     ...
     let url = {
         url: `https://mmwk.zhilaiw.cn/index.php/Api/Index/index?${ck[0]}`,
         headers: {
