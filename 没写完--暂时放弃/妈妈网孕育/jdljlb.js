...
class UserInfo {
    constructor(index, str) {
        ...
        if (tgLogFlag) {
            try {
                ...
                this.rel = 2
                this.source = 1
                this.statistics_app_channel = '010122qq'
    ...
    // 73F3AE8037D159D6406326CDE1AF9744
    ...
    async getSign() {
        ...
        // let t = $.ts(10)
        let t = '1668949957'
        this.token = 'reward_video_token%3A106543772%3A8vFfi'

        let a = `app_auth_token=${this.app_auth_token}&appkey=${this.appkey}&bb_birthday=${this.bb_birthday}&bid=${this.bid}&mode=${this.mode}&open_mmid=${this.open_mmid}&prepare_pt_date=&rel=${this.rel}&source=${this.source}&statistics_app_channel=${this.statistics_app_channel}&statistics_app_params=${this.statistics_app_params}&statistics_app_source=${this.statistics_app_source}&t=${t}&token=${this.token}&uid=${this.uid}&version=${this.version}${this.salt}`


        // `token=reward_video_token%3A106543772%3A8vFfi&open_mmid=fd4196854db380b47caf9eb6ab396f2ea5&uid=106543772&app_auth_token=7145c7d11a6f05cff1bbc7a3228b266abc6c5646&statistics_app_params=SnbCLQhwvWIr62t81H2HPphAsp8PqvCrN1G587kVMQJV7zWyQvKnvywA34xqCgBFY%252FWsImQdiE%252B4xcvBy94sx%252FaFc738iFn49q62dwDUUBlMUFKFw28V9OfI%252Bg7%252BUVWSqciK8Blx3fkojsPaScxPC2ZaAribYjenjT40%252FDzN2OXTVmkxdWu2mOxmhVJ6ynS%252FYhZ3q%252B%252BRa9fsDF8xHgNcJpfbASJx%252B4%252BKdndPdsmURki7Xow5QrnsJcYte9Fa3Tf8T5ts4gGAuvf%252Fooo%252FGXYHHWRfm%252ByDtJBEaLaZU%252BA6g6S4mghGxvEAO1zz04uMgHz9eaJ2Oy%252FNUS%252BXgIbhuppiuDg%252BmFpGccfhL7yO3NC5mivILF933%252BFCCwkj0ctEIki%252BIHLuU7k0TY9BrUCdzn9PxfOjyQZVtYNLcepEASZZGOXIZmx9hz4XmK8RRRaVPHs8U1T9ZFH0myB2nrs%252BGNsZ3iiQdh4SMAZ3%252BwMl5kHaot%252BQBpcSrRxTq9YNu%252FyFnRzU&statistics_app_channel=010122qq&statistics_app_source=pt_android&version=12.7.0&source=1&ruid=106543772&mode=2&rel=2&childbirth_status=1&t=1668949957&appkey=pt_android`
