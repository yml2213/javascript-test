 ...
 * 来电转  
 *
 * cron 20 7,12  * * *  yml2213_javascript_master/ldz.js
 *
 * 6-12		完成 签到 任务 (圈x v2p兼容测试中)
 *
 * 感谢所有测试人员
 * ========= 青龙--配置文件 =========
 * 变量格式: export ldz_data='X-Customer & X-Token @ X-Customer & X-Token '   ,多账号用 换行 或 @ 分割
 * 抓包 club-server/front/member/home  包, 找到 X - Token ,X - Customer 即可
 * ========= 重写 (测试中,有问题群里 @ 我吧) =========
 * url:   club-server/front/member/home
 * 类型:   script-request-header
 * 路径:   https://raw.githubusercontent.com/yml2213/javascript/master/ldz/ldz.js
 * 域名:   mc.kukahome.com
 * ====================================
...
let Change = '先跑着吧 ,每天0.3 到时候再说提现啥的!'
let thank = `\n感谢 心雨 的投稿\n`
//---------------------------------------------------------------------------------------------------------
...
async function user_info() {
	try {
		let Option = {
			...
			'{"call_phone":"","resource_type":1,"resource_id":"1518502953991471104","iscachedata":0}'
