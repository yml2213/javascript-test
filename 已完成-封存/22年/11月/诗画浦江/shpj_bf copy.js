...
async function signin() {
	...
	let _data1 = `/api/user_mumber/sign&&634d00d0f0edc004c015c9dc&&dc9033bf-fe6d-4f61-8e6f-98fd297ffd7c&&1666028386788&&FR*r!isE5W&&14`;
	console.log(_data);
	console.log(_data1);

	let sign = sha256_Encrypt(_data);

	let sign1 = sha256_Encrypt(_data1);
	console.log(sign);
	let options = {
		method: "Get",
