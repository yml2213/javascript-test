...
class UserInfo {
    ...
    async getSignStatus() {
        try {
            let param = { 'date': '' }
            let url = `https://yingsheng.elecfans.com/webapi/wapi/activity/signin/data?${$.json2str(param, '&')}`
            let body = ``
    ...
    async signin() {
        try {
            let param = { 'date': '' }
            let url = `https://yingsheng.elecfans.com/webapi/wapi/activity/signin/signin`
    ...
    async getTaskList() {
        try {
            let param = {}
            let url = `https://yingsheng.elecfans.com/webapi/wapi/activity/task/dailyList`
            let body = ``
            param = this.calculateSign_yingsheng(param)
            let urlObject = populateUrlObject(url, param, body)
            await httpRequest('get', urlObject)
    ...
    async taskReceive(task) {
        try {
            ...
            let url = `https://yingsheng.elecfans.com/webapi/wapi/activity/task/receive`
            let body = JSON.stringify(param)
            param = this.calculateSign_yingsheng(param)
            let urlObject = populateUrlObject(url, param, body)
            await httpRequest('post', urlObject)
    ...
    async receiveCoin(task) {
        try {
            let param = { 'type': task.type }
            let url = `https://yingsheng.elecfans.com/webapi/wapi/activity/task/receiveCoin`
            let body = JSON.stringify(param)
            param = this.calculateSign_yingsheng(param)
            let urlObject = populateUrlObject(url, param, body)
            await httpRequest('post', urlObject)
