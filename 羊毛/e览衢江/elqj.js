...
-------------------  青龙-配置文件-复制区域  -------------------
# e览衢江
export elqj=" PHPSESSID # X-SESSION-ID @ PHPSESSID # X-SESSION-ID "  

多账号用 换行 或 @ 分割  

抓 foyguk1n.act.tmuact.com 的包  cookie  里的 PHPSESSID 
...
// let device_no = `00000000-6641-8460-0000-000011944588`
...
class UserClass {
    ...
    async info() { // 信息
        ...
        if (resp.code == 0) {
            ...
            $.log(`${this.idx}: ${resp.data.rst.nick_name}, 积分:${resp.data.rst.total_integral}, id:${this.account_id}`)
