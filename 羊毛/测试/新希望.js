...
class UserClass {
    ...
    async security_code_auth(smsCode, phone) { // 获取登录code    client_id=10035&this.phone_number=16582963567&security_code=292419
        ...
        if (resp.code == "0000") {
            ...
            $.log(`${this.idx}: 获取token: ${resp.message}`)
            await this.invite()  // 邀请
    ...
    async invite() {
        ...
        let options = {
            ...
            headers: {
                ...
                "Content-Length": "70",
                "authorization": `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..utTH-erIrNoH4CDxEOtVbXDgnYS_0LU_VgKQFf3IKd4`,
                "charset": "utf-8",
                "x-requested-with": "XMLHttpRequest",
                "User-Agent": "Mozilla/5.0 (Linux; Android 9; Mi Note 3 Build/PKQ1.181007.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/107.0.5304.141 Mobile Safari/537.36 XWEB/5169 MMWEBSDK/20220903 MMWEBID/6209 MicroMessenger/8.0.28.2240(0x28001C35) WeChat/arm64 Weixin NetType/WIFI Language/zh_CN ABI/arm64 MiniProgramEnv/android",
                "Content-Type": "application/json;charset\u003dutf8",
                "Referer": "https://servicewechat.com/wxd783c47e55dce1de/584/page-frame.html"
            },
            json: {
