...
const ck_ = `372330199706166653#6653
43082119781108682X#682X  
37098220031217272X#272X`  // 赵工
// const ck_ = `37098220031217272X#272X`  // 张玉
...
class User {
    ...
    async login() {
        ...
        if (res.code === 200) {
            ...
            for (const a of res.data.apply) {
                if (a.subjectTitleFull = '电工作业\/高压电工作业\/初培') {
    ...
    async big_taskList() {
        const options = {
            method: "get",
            url: `https://jinchibang.taijieyun.com/index/material/mslist?msid=67&applyid=${this.applyid}&cate=%E7%90%86%E8%AE%BA`,
            headers: this.hd,
