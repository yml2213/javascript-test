...
class User {
    constructor(str, id) {
        ...
        this.app_name = "浩看小说"
        this.wxappid = "wx0488b2337ff4a61a"
        this.login_host = "dj.palmestore.com"
        this.welfare_host = "dj.palmestore.com"
        this.p2 = "331016"                   // 七猫 136002   浩看 331016
        this.p3 = "24004556"                 // 七猫 25026056   浩看 24004556
        this.p7 = "__f9267e3c57362c76"       // p31
        this.p9 = "1"                        // 七猫 3   浩看 1
        this.p16 = "M2102J2SC"
        this.p21 = "1303"
        this.p22 = "12"                       // 安卓版本
        ...
        this.pluginVersion = "811.8"



        this.hd = {
            "Host": "dj.palmestore.com",
            "user-agent": "Dalvik/2.1.0 (Linux; U; Android 12; M2102J2SC Build/SKQ1.211006.001)",
    ...
    // https://dj.palmestore.com/zyuc/api/user/accountInfo
