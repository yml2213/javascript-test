...
function getCode(phone) {
    ...
    let ts = ts13()
    let reqSign = MD5_Encrypt(`signature${reqNonc}${ts}${salt}${version}`)
...
// {"mobilePhone":"13754650804","registrationId":"160a3797c8e5a391c64","smsCode":"212752"}
function getToken(phone, code) {
    var { body, headers, status } = request({
        ...
        // dataType: "json",
        headers: { "Content-Type": "application/json; charset=UTF-8" },
        body:{"mobilePhone":phone,"registrationId":"160a3797c8e5a391c64","smsCode":code},
        allowredirects: false, //不禁止重定向
    })
