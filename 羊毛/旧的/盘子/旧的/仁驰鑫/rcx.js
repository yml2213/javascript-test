...
class UserInfo {
    constructor(index, str) {
        ...
        this.pwd = this.ck[1];
        this.hostname = 'https://plm88.renchixin88.com';
    }
    ...
    async do_daka(name, type) {
        let options = {
            method: "post",
            url: `${this.hostname}/handle/daka2`,
            headers: {
                'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8',
                'Cookie': this.cookie,
            },
    ...
    async do_sign() {
        ...
        let options = {
            method: "post",
            url: `${this.hostname}/handle/qiandao`,
            headers: {
                'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8',
                'Cookie': this.cookie,
            },
    ...
    async user_info() {
        ...
        let options = {
            method: "get",
            url: `${this.hostname}/mobile/index.html`,
            headers: {
        ...
        let res = await httpRequest(options);
        // console.log(res);
        let data_ = res.split('<b id="jifen">')[1].split('</b>个袋子')[0];
