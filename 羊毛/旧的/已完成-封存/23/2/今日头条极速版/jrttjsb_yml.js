...
激进版定时： 1-59/5 * * * *
阅读失效修复：
抓包搜索 luckycat/lite/v1/activity，用抓到的https://api5-normal-lf.toutiaoapi.com/luckycat/lite/v1/activity/done_whole_scene_task/?pass_through……替换236行相关链接。

23/2/3      yml 修复小 bug  自己


青龙变量：抓包搜索 luckycat/lite/v1/activity，将cookie填入 jrttjsbHeader 变量，多账户用@隔开
自定义UA：捉包拿到自己的UA，填到变量jrttjsbUA里，不填默认用安卓UA
阅读文章数量：填到变量jrttjsbReadNum，不填默认10篇
农场和种树任务：默认不做，需要做的，把变量jrttjsbFarm填为1，下列内容复制到青龙config。
## 今日头条极速版
export jrttjsbHeader="install_id=132404293936589;ttrxxxx"
export jrttjsbUA="Dalvik/2.1.0 (Linux; U; Android 10; xxxx"
...
async function ReadArtsReward() {
    ...
    let url = `${hostname}/luckycat/lite/v1/activity/done_whole_scene_task/?pass_through=default&is_pad=0&iid=2265465444901831&device_id=1869625912470847&ac=wifi&channel=lite_xiaomi_64&aid=35&app_name=news_article_lite&version_code=917&version_name=9.1.7&device_platform=android&os=android&ab_version=668907%2C4433945%2C5109770%2C5450457%2C5472940%2C668905%2C5450425%2C668903%2C5450451%2C668908%2C5450461%2C5315660%2C5461794%2C1859937%2C668906%2C5450433%2C668904%2C5450416%2C668776%2C5450454%2C4743964&ab_client=a1%2Ce1%2Cf2%2Cg2%2Cf7&ab_group=z1&ab_feature=z1&abflag=3&ssmix=a&device_type=M2102J2SC&device_brand=Xiaomi&language=zh&os_api=31&os_version=12&manifest_version_code=9170&resolution=1080*2206&dpi=440&update_version_code=91712&_rticket=1675401952104&sa_enable=0&dq_param=0&plugin_state=825742824972309&isTTWebView=0&session_id=47bd50ab-713c-4b4c-8df9-60318dc7a3dc&host_abi=arm64-v8a&tma_jssdk_version=2.53.0&rom_version=miui_v130_v13.0.6.0.sgacnxm&cdid=46816f99-bbc7-42c2-97de-0fd774157be6&polaris_version=1.0.5&status_bar_height=32`
...
async function DailyArtsReward() {
    ...
    // console.log(result)
    if (result.err_no == 0) {
        console.log(`用户${userIdx + 1}领取每日阅读奖励 ${result.err_tips}`)
    } else {
...
async function ExcitationAd(task_id) {
    ...
    let caller = printCaller()
    let timeInMS = Math.round(new Date().getTime())
    let url = `${hostname}/luckycat/lite/v1/task/done/excitation_ad?pass_through=default&is_pad=0&act_token=JL1HtwPHpvxHv_rcZQtKAC3ajuo-5azRQIvjbqJ6IzTAVtWR7EY0xlY06pA-0Zt20xMGw7GE1fPabIBqQE8pPw&act_hash=9da3c5e7bb026f0eff562764c9acc7e0&cookie_base=H-WaAsR8Y-beqKCfWCVyEih4XmEeLj9OlveW2Bswl8EKdR7DS9onPILukxh3Fi5qRwKVtr3wHSG4ATcEbn-Dj5aGAuGWeoH56k8wZtIjJaA&cookie_data=yOg0jvd7ihkqR-WciihsFA&iid=2819597821290968&device_id=4244563972598088&ac=wifi&channel=lite_xiaomi_64&aid=35&app_name=news_article_lite&version_code=880&version_name=8.8.0&device_platform=android&os=android&ab_version=668776%2C4174795%2C668907%2C4174798%2C1859937%2C668905%2C4174766%2C668906%2C4174774%2C668904%2C4174751%2C668903%2C4174792%2C668908%2C4174802%2C3596061%2C4007849%2C4046906%2C4071697%2C4098661%2C4126737%2C4131037%2C4098838&ab_client=a1%2Ce1%2Cf2%2Cg2%2Cf7&ab_feature=z1&abflag=3&ssmix=a&device_type=22041211AC&device_brand=Redmi&language=zh&os_api=31&os_version=12&manifest_version_code=8800&resolution=1080*2280&dpi=420&update_version_code=88011&_rticket=${timeInMS}&sa_enable=0&dq_param=0&plugin_state=280419485511709&isTTWebView=1&session_id=82e83565-d2ca-47f3-a50b-5268dfd25a3a&host_abi=arm64-v8a&tma_jssdk_version=2.8.0.16&rom_version=miui_v130_v13.0.13.0.slncnxm&cdid=84ee2972-20d3-4b4e-ae10-b9ddcb1647ea&polaris_version=1.0.5&status_bar_height=29&luckydog_base=rBGqzakReKG1QpYNj3-hS1Rz0r1i-BYhGoCDMYsCqbu9JQbbmS3Ou7H4xAY7R5rTTJ-ia6K8iTQh-dGhXvnjyoVRkA0ldRfI4IM0qDGKF15PVuK9-NsBsdZybYpIyNMzOAIw300pgezuxrf1jFuSgHhfF7Iyt-nLd7EVGh0nsr0&luckydog_data=Ui61fJQ-9iBJBqLTyqqB_xXhSXNt_0bp1RgP7lnnk0yI8sDNBnRy4ef_HqCaw8vsjJRGjFPj7OfPZnwXWsTblLJoNGoFSJ7e3WYyuGF7A8Q&luckydog_token=F3c5TeVJoC5GxpnvQWnCm3Vci0Y2ODjz3qHi9hAnURa8_ZyVOm-Sv44zIxkk8DkhyKT4iuD7WvxAkEpytbobBg&luckydog_sdk_version=5.0.1-rc.11&luckydog_settings_version=15&luckycat_version_name=5.0.1-rc.26&luckycat_version_code=501026`
    let body = `{"ad_id":11,"amount":1543,"ad_rit":"11","extra_data":{"enter_from":"task"},"task_key":"excitation_ad","extra":{"track_id":"7101510817782301470"},"task_id":"${task_id}","ad_alias_position":"coin","is_post_login":false,"ad_from":"coin","score_source":1,"coin_count":1543,"exci_extra":{"cid":1731121759811619,"req_id":"202205251129010102120720761B2CD0B2","rit":20047}}`
    let urlObject = populatePostUrl(url, body)
    await httpPost(urlObject, caller)
    let result = httpResult
    if (!result) return
