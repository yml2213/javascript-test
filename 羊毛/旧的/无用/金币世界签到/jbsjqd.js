...
async function yml() {
    ...
    function cq(timeout = 0) {
        return new Promise((resolve) => {
            let url = {
                url: `http://apijb.sunql.top:4002/Index/QianDao`,
                headers: {
                    'Host': 'apijb.sunql.top:4002',
                    'Connection': 'keep-alive',
                    'Content-Length': '47',
                    'Origin': 'http://appjb.sunql.top:91',
                    'custom-header': 'hello',
                    'content-type': 'application/x-www-form-urlencoded',
                    'Referer': 'http://appjb.sunql.top:91/',
                    'Accept-Encoding': 'gzip, deflate',
                    'Accept-Language': 'zh-CN,en-US;q=0.8',
                    'X-Requested-With': 'plus.H575B15EF',
                },
                body: body,
            ...
            $.post(url, async (err, resp, data) => {
                ...
                try {
                    ...
                    if (result.code === 'ok') {
                        $.log(`\n【🎉🎉🎉 恭喜您鸭 🎉🎉🎉】状态: ${result.msg} ✅ 恭喜${result.msgc}`)
                        await $.wait(2 * 1000);
