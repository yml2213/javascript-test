/**
 * 脚本地址: https://raw.githubusercontent.com/yml2213/javascript/master/kanjia/kanjia.js
 * 转载请留信息,谢谢
 *
 * 欧尚砍价
 *
 * cron 30 6 * * *  yml2213_javascript_master/kanjia.js
 *
 ...
 * 感谢所有测试人员
 * ========= 青龙--配置文件 =========
 * 变量格式: export kanjia_data='token @ token '  多个账号用 @ 或者 换行分割
 *
...
///////////////////////////////////////////////////////////////////
let ckStr = process.env.kanjia_data;
let msg = "";
let ck = "";
...
!(async () => {
	let ckArr = await getCks(ckStr, "kanjia_data");
	await tips(ckArr);
