...
//====================================================================================================
let code_tips = '当前版本:v7, 增加卡密次数合并功能, 默认将第二张卡密的次数转移到第一张中, 两张卡密使用 @ 分割\n'
        ...
        if (database_data) {
            ...
            if (database_data_2) {
                ...
                if (answer_index == -1) {
                    ...
                    if (typeof database_data_2 == 'number') {
                        database_data_2 = database_data_2 + ''
                        answer_index = opt.indexOf(database_data_2)

                    } else if (typeof database_data_2 == 'string') {
                        // answer_index = opt.indexOf(database_data_2)
                        // console.log(`字符串`)
                        try {
                            $.log(`${this.idx}: gpt 时间...`)
