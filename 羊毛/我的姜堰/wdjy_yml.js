...
-------------------  青龙-配置文件-复制区域  -------------------
# 我的姜堰 
export wdjy=" cookie#备注  @ cookie#备注  "  
export wdjy_code="你的卡密"    需要购买卡密请前往: https://yml-git.tk   
...
class UserClass {
    ...
    async userTask() {
        ...
        $.log(`\n-------------- 开始任务 --------------`)
        // await this.login() // 登录
        let url = 'https://statistic.cm.jstv.com/api/ArticleStatistic/QueryComments?globalId=25645835&orderType=0&pageIndex=1&pageSize=10'
        let body = {}
        await this.getSign(url, body)
