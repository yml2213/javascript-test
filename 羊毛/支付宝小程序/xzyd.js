...
async function main(userInfo) {
    for (let d = 2021004102680000; d < 2021004102690003; d++) {
        //await $.wait(3)
        await userInfo.sign(d)
        if (this.b == 1) break
    }
...
class UserInfo {
    ...
    async sign(d) {
        ...
        let options = {
            method: "post",
            url: `https://leshan.feigelaowu.cn/api/sys/saveCollected`,
            headers: {
                "Accept-Charset": "UTF-8",
                "X-token": this.ck,
                "referer": "https://2021004102680003.hybrid.alipay-eco.com/2021004102680003/0.2.2308081128.45/index.html#pages/index/index",
                "appid": `${d}`,
                //  "User-Agent": "Mozilla/5.0 (Linux; U; Android 9; zh-CN; Mi Note 3 Build/PKQ1.181007.001) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/69.0.3497.100 UWS/3.22.2.59 Mobile Safari/537.36 UCBS/3.22.2.59_230213152242 ChannelId(5) NebulaSDK/1.8.100112 Nebula AlipayDefined(nt:WIFI,ws:393|0|2.75,ac:sp) AliApp(AP/10.5.8.8000) AlipayClient/10.5.8.8000 Language/zh-Hans useStatusBar/true isConcaveScreen/false Region/CNAriver/1.0.0",
                "Content-Type": "application/x-www-form-urlencoded",
                "x-release-type": "ONLINE",
                "token": this.ck,
                "Content-Type": "application/x-www-form-urlencoded",
                "alipayMiniMark": "Oy/BTOL5yYxyOTRa3YIVLddwfZVTBU4YUEc0QnpuAHz5wEheR0hA64tN6gvEQeh0ZsrdSanTLvchs5AU0f0XS3URgkJ4swA3Zgris7kXg8c\u003d",
                // "Accept-Encoding": "gzip",
                "Content-Length": "61",
                "Host": "leshan.feigelaowu.cn",
                "Connection": "Keep-Alive"
            },
            body: `appid=${d}&token=${this.ck}`
        }
        // console.log(options);
        ...
        //  console.log(res);
        if (res.code == 0) {
            this.cusLog(`获取id ${d}  :  收藏奖励领取`)
        } else if (res.code == 500) {
            this.b = 1
            this.cusLog(`账号 ${this.index}  :  ${d} ${res.msg}`)
