...
const _0xe20ba7 = async (_0x4b9807, _0x30aa83, _0xa2bf5d = 1) => {
  ...
  const _0x5be737 = {
    ...
    "method": "POST",
    "headers": _0x5685c1,
    "body": JSON.stringify(_0x104c99)
  };
  return _0x3149db(_0xd461c8 => {
    _0x509dd2(_0x5be737, async (_0x5285f3, _0x451d79, _0x1333f5) => {
      if (!_0x5285f3 && _0x451d79.statusCode === 200) {
        const _0x47ea13 = JSON.parse(_0x1333f5);

        if (_0x47ea13.code !== 20000) {
          console.error(_0x47ea13.message);
          process.exit(0);
        } else {
          _0xd461c8(_0x47ea13.data.msg);
        }
      } else {
...
function _0x4e5055(_0x16868e) {
  if (!_0x16868e) {
    return "-1";
  }

  for (var _0x19c04c = _0x16868e.split(";"), _0x46eba0 = 0; _0x46eba0 < _0x19c04c.length; _0x46eba0++) {
    var _0xefd463 = _0x19c04c[_0x46eba0].split("=");

    if ([" _m_h5_tk", "_m_h5_tk"].includes(_0xefd463[0])) {
      return _0xefd463[1];
    }
  }
...
function _0x1009b3(_0xb73c7, _0x1f6746, _0x3e1e16, _0x519778, _0x4bf1a9 = 5) {
  const _0x59fa3f = {
    "url": "https://waimai-guide.ele.me/h5/mtop.alsc.personal.queryminecenter/1.0/?jsv=2.6.2&appKey=12574478",
    "headers": {}
  };
  _0x59fa3f.headers.Cookie = _0xb73c7;
  _0x59fa3f.headers.method = "GET";
  _0x59fa3f.headers["User-Agent"] = "Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/50.0.2661.87 Safari/537.36";
  return _0x3149db(_0x59373e => {
    try {
      _0x509dd2(_0x59fa3f, async (_0x155157, _0xc40321, _0x50582e) => {
        if (!_0x155157 && _0xc40321.statusCode === 200) {
          const _0x5d5d66 = JSON.stringify(_0xc40321.headers["set-cookie"]);

          const _0x43704d = /_m_h5_tk=(\S*);/;

          const _0x5dc3a1 = _0x5d5d66.match(_0x43704d)[1];

          const _0x4533ed = " _m_h5_tk=" + _0x5dc3a1.split(";")[0];

          const _0x445072 = /_m_h5_tk_enc=(\S*);/;

          const _0x18d580 = _0x5d5d66.match(_0x445072)[1];

          const _0x1e443b = " _m_h5_tk_enc=" + _0x18d580.split(";")[0];

          _0xb73c7 = _0x2c8466(_0x4533ed, _0x1e443b, _0xb73c7);

          if (_0x4bf1a9 <= 0) {
            console.log("第", _0x1f6746 + 1, "cookie存在异常，请检查");

            _0x59373e(null);
          } else {
            _0x59373e(await _0x384ce0(_0xb73c7, _0x1f6746, _0x3e1e16, _0x519778, _0x4bf1a9 - 1));
          }
        } else {
          _0x59373e(null);
        }
      ...
      console.log(_0x15d0c6);
    }
  });
}

function _0x2c8466(_0x50200a, _0x18a11f, _0x31e4ea) {
  let _0x140d65 = false;

  for (var _0x460aee = _0x31e4ea.split(";"), _0x51dbd6 = 0; _0x51dbd6 < _0x460aee.length; _0x51dbd6++) {
    var _0x17c9ff = _0x460aee[_0x51dbd6].split("=");

    if (["_m_h5_tk", " _m_h5_tk"].indexOf(_0x17c9ff[0]) > -1) {
      _0x140d65 = true;
      _0x460aee[_0x51dbd6] = _0x50200a;
    }

    if ([" _m_h5_tk_enc", "_m_h5_tk_enc"].indexOf(_0x17c9ff[0]) > -1) {
      _0x460aee[_0x51dbd6] = _0x18a11f;
      _0x140d65 = true;
    }
  }
  ...
  if (_0x140d65) {
    for (_0x51dbd6 = 0; _0x51dbd6 < _0x460aee.length; _0x51dbd6++) {
      _0x5f3cce += _0x460aee[_0x51dbd6];
      _0x51dbd6 != _0x460aee.length - 1 && (_0x5f3cce += ";");
    }
  } else {
    _0x5f3cce = _0x31e4ea + ";" + _0x50200a + ";" + _0x18a11f;
  }
...
const _0x384ce0 = async (_0x1da3cd, _0x44b996, _0x3711d3, _0x50caba, _0x3286fb = 5) => {
  _0x1da3cd = _0x1da3cd.replace(/\s/g, "");

  let _0x17263c = _0x4e5055(_0x1da3cd);

  _0x17263c = _0x17263c.split("_")[0];
  let _0x494623 = {};

  let _0x3790fd = JSON.stringify(_0x494623);

  let _0x166338 = 12574478;

  let _0x4a5fef = new Date().getTime();

  let _0x8e599a = await _0xe20ba7(_0x17263c + "&" + _0x4a5fef + "&" + _0x166338 + "&" + _0x3790fd, _0x3711d3, _0x50caba);

  const _0x26f222 = {
    "Cookie": _0x1da3cd,
    "User-Agent": _0x3f077c
  };
  const _0x33fa9d = {
    "url": "https://shopping.ele.me/h5/mtop.alsc.user.session.ele.check/1.0/?H5Request=true&api=mtop.alsc.user.session.ele.check&appKey=12574478&data={}&dataType=json&jsv=2.6.2&mainDomain=ele.me&pageDomain=ele.me&sign=" + _0x8e599a + "&subDomain=shopping&t=" + _0x4a5fef + "&timeout=5000&type=json&v=1.0",
    "method": "GET",
    "headers": _0x26f222
  };
  return _0x3149db(_0x1e9801 => {
    try {
      _0x509dd2(_0x33fa9d, async (_0x1f889a, _0x5d9798, _0x2b2f34) => {
        if (!_0x1f889a && _0x5d9798.statusCode === 200) {
          const _0x3ebd88 = JSON.parse(_0x2b2f34);

          if (_0x3ebd88.data.errorCode === "000502") {
            console.log("第", _0x44b996 + 1, "账号失效！请重新登录！！！😭");

            _0x1e9801(null);
          } else {
            if (_0x3286fb <= 0) {
              console.log("第", _0x44b996 + 1, "cookie存在异常，请检查");

              _0x1e9801(null);
            }

            if (_0x3ebd88.ret.includes("FAIL_SYS_TOKEN_EXOIRED::令牌过期") || _0x3ebd88.ret.includes("FAIL_SYS_TOKEN_EMPTY::令牌为空")) {
              _0x1e9801(await _0x1009b3(_0x1da3cd, _0x44b996, _0x3711d3, _0x50caba, _0x3286fb - 1));
            } else {
              _0x1e9801(_0x1da3cd);
            }
          }
        } else {
          if (_0x1f889a && _0x1f889a.message.indexOf("Invalid character in header content [\"Cookie\"]") !== -1) {
            console.log("第", _0x44b996 + 1, "账号ck不合法，请确认！！！");
          } else {
            console.log(_0x1f889a);
          }
...
const _0xb95eb1 = async (_0x135a88, _0x44d462, _0x3e8c39, _0x3b2612 = 5) => {
  _0x135a88 = _0x135a88.replace(/\s/g, "");

  let _0x36722b = _0x4e5055(_0x135a88);

  _0x36722b = _0x36722b.split("_")[0];
  let _0x4120e2 = {};

  let _0x5503e6 = JSON.stringify(_0x4120e2);

  let _0x41c719 = 12574478;

  let _0x22f2a5 = new Date().getTime();

  let _0x3291d3 = await _0xe20ba7(_0x36722b + "&" + _0x22f2a5 + "&" + _0x41c719 + "&" + _0x5503e6, _0x44d462, _0x3e8c39);
  ...
  const _0x2e6f8a = {
    "url": "https://shopping.ele.me/h5/mtop.alsc.user.session.ele.check/1.0/?H5Request=true&api=mtop.alsc.user.session.ele.check&appKey=12574478&data={}&dataType=json&jsv=2.6.2&mainDomain=ele.me&pageDomain=ele.me&sign=" + _0x3291d3 + "&subDomain=shopping&t=" + _0x22f2a5 + "&timeout=5000&type=json&v=1.0",
    "method": "GET",
    "headers": _0x3a11d5
  };
  return _0x3149db(_0x49e314 => {
    try {
      _0x509dd2(_0x2e6f8a, async (_0x4f09d4, _0x296540, _0x28157c) => {
        if (!_0x4f09d4 && _0x296540.statusCode === 200) {
          const _0x32f17d = JSON.parse(_0x28157c);

          if (_0x32f17d.data.errorCode === "000502") {
            _0x49e314(null);
          } else {
            if (_0x3b2612 <= 0) {
            ...
            if (_0x32f17d.ret.includes("FAIL_SYS_TOKEN_EXOIRED::令牌过期") || _0x32f17d.ret.includes("FAIL_SYS_TOKEN_EMPTY::令牌为空")) {
              _0x49e314(await _0x2ecce9(_0x135a88, _0x44d462, _0x3e8c39, _0x3b2612 - 1));
            } else {
              _0x49e314(_0x135a88);
            }
          }
        } else {
          if (_0x4f09d4 && _0x4f09d4.message.indexOf("Invalid character in header content [\"Cookie\"]") !== -1) {
...
function _0x2ecce9(_0x2e91a7, _0x5c0329, _0x40efa0, _0xead858 = 5) {
  const _0x3316fb = {
    "url": "https://waimai-guide.ele.me/h5/mtop.alsc.personal.queryminecenter/1.0/?jsv=2.6.2&appKey=12574478",
    "headers": {}
  };
  _0x3316fb.headers.Cookie = _0x2e91a7;
  _0x3316fb.headers.method = "GET";
  _0x3316fb.headers["User-Agent"] = "Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/50.0.2661.87 Safari/537.36";
  return _0x3149db(_0x511c0a => {
    try {
      _0x509dd2(_0x3316fb, async (_0x4b7977, _0x4138fa, _0x3309fa) => {
        if (!_0x4b7977 && _0x4138fa.statusCode === 200) {
          const _0x141e4e = JSON.stringify(_0x4138fa.headers["set-cookie"]);

          const _0x55f24d = /_m_h5_tk=(\S*);/;

          const _0x51f013 = _0x141e4e.match(_0x55f24d)[1];

          const _0x45b410 = " _m_h5_tk=" + _0x51f013.split(";")[0];

          const _0x15368d = /_m_h5_tk_enc=(\S*);/;

          const _0xd5fc4b = _0x141e4e.match(_0x15368d)[1];

          const _0x4ea3ea = " _m_h5_tk_enc=" + _0xd5fc4b.split(";")[0];

          _0x2e91a7 = _0x2c8466(_0x45b410, _0x4ea3ea, _0x2e91a7);
          ...
          if (_0xead858 <= 0) {
            ...
            _0x511c0a(await _0xb95eb1(_0x2e91a7, _0x5c0329, _0x40efa0, _0xead858 - 1));
          }
        } else {
          _0x511c0a(null);
        }
...
function _0x46f1d2(_0x3c03d6) {
  return new Promise(_0x46080c => {
    _0x3bc5b1(_0x3c03d6, function (_0x437769, _0x373f29, _0x35ef0c) {
      if (_0x437769) {
        console.error(_0x437769);
...
const _0x559415 = async (_0x5e3a60, _0x2698bb) => {
  const _0xcc288a = _0x3e0262 + "/check/kami/count?carmi=" + _0x5e3a60 + "&success=" + _0x2698bb + "&isNew=true";

  const _0x19ac94 = {
    "url": _0xcc288a,
    "method": "GET"
  };
  return _0x3149db(_0x30cef4 => {
    _0x509dd2(_0x19ac94, async (_0x370f31, _0x36152a, _0x52ffa4) => {
      if (!_0x370f31 && _0x36152a.statusCode === 200) {
        let _0x26c4a5 = JSON.parse(_0x52ffa4);

        if (!_0x26c4a5.code || _0x26c4a5.code !== 20000) {
          console.error("❌ " + _0x26c4a5.error || _0x26c4a5.message);
          process.exit(0);
        } else {
          _0x30cef4(_0x26c4a5.data.count);
        }
      } else {
        console.log("网络异常，请检查网络状况");
        process.exit(0);
...
const _0xe30d85 = async (_0x9b5155, _0x382a0d, _0x558a93) => {
  const _0x34ec4c = {
    "carmi": _0x9b5155,
    "userId": _0x382a0d,
    "gameType": _0x558a93
  ...
  const _0x4610f8 = _0x3e0262 + "/check/kami/count?carmi=" + _0x9b5155;
  ...
  const _0xb61d9a = {
    ...
    "method": "POST",
    "headers": _0x3dccfc,
    "body": JSON.stringify(_0x34ec4c)
  };
  return _0x3149db(_0xbfdc82 => {
    _0x509dd2(_0xb61d9a, async (_0xac0b0, _0x1cb3d7, _0x57630c) => {
      if (!_0xac0b0 && _0x1cb3d7.statusCode === 200) {
        const _0x4d7942 = JSON.parse(_0x57630c);

        if (_0x4d7942.code !== 20000) {
          console.error(_0x4d7942.message);
          process.exit(0);
        }
...
const _0xd8867f = async (_0x57fd7c, _0x5bb9f2) => {
  if (!_0x57fd7c) {
    console.log("❌卡密不能为空");
    process.exit(0);
  }

  const _0x439595 = await _0x46f1d2("head -1 /proc/self/cgroup|cut -d/ -f3|cut -c1-12");

  const _0x104961 = _0x3e0262 + "/check/kami?carmi=" + _0x57fd7c + "&type=" + _0x5bb9f2 + "&containerId=" + _0x439595 + "&isNew=true";

  const _0x2f5d12 = {
    "url": _0x104961,
    "method": "GET"
  };
  return _0x3149db(_0x30b350 => {
    _0x509dd2(_0x2f5d12, async (_0x48a6fe, _0x8c0090, _0x1e30eb) => {
      if (!_0x48a6fe && _0x8c0090.statusCode === 200) {
        const _0xfa2049 = JSON.parse(_0x1e30eb);

        if (_0xfa2049.code !== 20000) {
          console.error(_0xfa2049.message);
          process.exit(0);
        } else {
          console.log("\n" + _0xfa2049.data.msg);
...
async function _0x3149db(_0x3e795f) {
  return new Promise(_0x703687 => {
    try {
      _0x3e795f(_0x703687);
    } catch (_0x5dc58c) {
      console.log(_0x15d0c6);
...
function _0x272806(_0x4bef50) {
  var _0x290597 = "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ-_";
  var _0x4677ee = "";

  for (var _0x522c91 = _0x4bef50; _0x522c91 > 0; --_0x522c91) {
    _0x4677ee += _0x290597[Math.floor(Math.random() * _0x290597.length)];
  }

  return _0x4677ee;
}

function _0x145dce(_0x124c99) {
  let _0x38899d = /^(\S+)=(\S+)$/;

  let _0x34f3e2 = _0x124c99.replace(/\s*/g, "").split(";");

  let _0x14b41c = new Map();

  for (let _0x2e49b0 of _0x34f3e2) {
    let _0x1833b4 = _0x38899d.exec(_0x2e49b0);

    if (_0x1833b4) {
      _0x14b41c.set(_0x1833b4[1], _0x1833b4[2]);
    }
  }
...
function _0x46a23e() {
  console.log("版本：2.3.7");
  let _0x4b4af6 = [];

  if (process.env.elmck) {
    if (process.env.elmck.indexOf("&") > -1) {
      _0x4b4af6 = process.env.elmck.split("&");
    } else {
      if (process.env.elmck.indexOf("\n") > -1) {
        _0x4b4af6 = process.env.elmck.split("\n");
      } else {
        _0x4b4af6 = [process.env.elmck];
      }
    }
  }
...
const _0x415eb7 = _0x1ebdc4 => {
  ...
  return _0x3149db(_0x567590 => {
    _0x509dd2(_0x46f54a, async (_0x4d63d3, _0x37324f, _0x2ae4a2) => {
      if (!_0x4d63d3 && _0x37324f.statusCode === 200) {
        _0x567590(JSON.parse(_0x2ae4a2));
      } else {
        _0x567590({});
      }
    });
...
function _0x3e6c97(_0x29a6ff) {
  const _0x50b3a3 = _0x29a6ff.split(";").map(_0x356c3b => _0x356c3b.trim().split("="));

  const _0x54843b = new Map();

  for (let _0x13def0 = 0; _0x13def0 < _0x50b3a3.length; _0x13def0++) {
    const [_0xa8897e, _0x350f26] = _0x50b3a3[_0x13def0];

    if (_0xa8897e) {
      _0x54843b.set(_0xa8897e, decodeURIComponent(_0x350f26));
    }
  }
...
async function _0x2a292f(_0x5a7cd7, _0x537b5a) {
  const _0x4553f9 = _0x3e6c97(_0x5a7cd7);

  if (!_0x4553f9.has("wxUid")) {
    console.log("没有获取到推送 uid，不推送消息\n");
  } else {
    await sendNotify("登录失效通知", "### 通知 \n 备注为：" + _0x537b5a + "的饿了么登录已失效，请重新登录", {
      "uid": _0x4553f9.get("wxUid")
    });
  }
}

function _0x3d2823(_0x36e367, _0x16e11d, _0x2a82b7, _0x4ee381, _0x12f5db, _0xdfb86d, _0x242019) {
  const _0x136dd3 = {
    "data": _0x36e367,
    "api": _0x16e11d,
    "pageId": decodeURIComponent(_0x2a82b7),
    "uid": _0x12f5db,
    "deviceId": _0xdfb86d,
    "utdid": _0x242019
  };
  const _0x51c0a4 = {
    ...
    "needSignData": _0x136dd3
  };

  if (_0x4ee381) {
    _0x51c0a4.needSignData.sid = _0x4ee381;
  }

  _0x51c0a4.needSignData = encodeURIComponent(JSON.stringify(_0x51c0a4.needSignData));
  const _0x9ef302 = {
    "method": "POST",
    "headers": {},
    "url": "http://permission.94wan.fun/check/xsign",
    "body": JSON.stringify(_0x51c0a4)
  };
  _0x9ef302.headers["content-type"] = "application/json";
  return _0x3149db(resolve => {
    _0x509dd2(_0x9ef302, async (_0x3974be, _0x1d6b45, resp) => {
      if (!_0x3974be && _0x1d6b45.statusCode === 200) {
        try {
...
async function _0x5ce2df(cookie_) {
  let cookieData = _0x3e6c97(cookie_);

  let _0x4b9a0c = cookieData.get("deviceId");

  let _0x53db0c = cookieData.get("utdid");

  let _0x820957 = cookieData.get("USERID");

  let token_ = cookieData.get("token");
  ...
  let _0x29f24c = cookieData.get("umt");

  let bd_data = "{\"ext\":\"{\\\"apiReferer\\\":\\\"{\\\\\\\"errorCode\\\\\\\":\\\\\\\"7\\\\\\\",\\\\\\\"eventName\\\\\\\":\\\\\\\"autologinFailed\\\\\\\"}{\\\\\\\"errorCode\\\\\\\":\\\\\\\"7\\\\\\\",\\\\\\\"eventName\\\\\\\":\\\\\\\"autologinFailed\\\\\\\"}{\\\\\\\"errorCode\\\\\\\":\\\\\\\"7\\\\\\\",\\\\\\\"eventName\\\\\\\":\\\\\\\"autologinFailed\\\\\\\"}{\\\\\\\"errorCode\\\\\\\":\\\\\\\"7\\\\\\\",\\\\\\\"eventName\\\\\\\":\\\\\\\"autologinFailed\\\\\\\"}{\\\\\\\"errorCode\\\\\\\":\\\\\\\"7\\\\\\\",\\\\\\\"eventName\\\\\\\":\\\\\\\"autologinFailed\\\\\\\"}{\\\\\\\"errorCode\\\\\\\":\\\\\\\"7\\\\\\\",\\\\\\\"eventName\\\\\\\":\\\\\\\"autologinFailed\\\\\\\"}{\\\\\\\"errorCode\\\\\\\":\\\\\\\"7\\\\\\\",\\\\\\\"eventName\\\\\\\":\\\\\\\"autologinFailed\\\\\\\"}{\\\\\\\"errorCode\\\\\\\":\\\\\\\"7\\\\\\\",\\\\\\\"eventName\\\\\\\":\\\\\\\"autologinFailed\\\\\\\"}{\\\\\\\"errorCode\\\\\\\":\\\\\\\"7\\\\\\\",\\\\\\\"eventName\\\\\\\":\\\\\\\"autologinFailed\\\\\\\"}{\\\\\\\"errorCode\\\\\\\":\\\\\\\"7\\\\\\\",\\\\\\\"eventName\\\\\\\":\\\\\\\"autologinFailed\\\\\\\"}\\\"}\",\"userId\":\"" + _0x820957 + "\",\"tokenInfo\":\"{\\\"appName\\\":\\\"24895413\\\",\\\"appVersion\\\":\\\"android_11.1.38\\\",\\\"deviceId\\\":\\\"" + _0x4b9a0c + "\\\",\\\"deviceName\\\":\\\"Android(AOSP on blueline)\\\",\\\"ext\\\":{\\\"aFrom\\\":\\\"{\\\\\\\"errorCode\\\\\\\":\\\\\\\"7\\\\\\\",\\\\\\\"eventName\\\\\\\":\\\\\\\"autologinFailed\\\\\\\"}{\\\\\\\"errorCode\\\\\\\":\\\\\\\"7\\\\\\\",\\\\\\\"eventName\\\\\\\":\\\\\\\"autologinFailed\\\\\\\"}{\\\\\\\"errorCode\\\\\\\":\\\\\\\"7\\\\\\\",\\\\\\\"eventName\\\\\\\":\\\\\\\"autologinFailed\\\\\\\"}{\\\\\\\"errorCode\\\\\\\":\\\\\\\"7\\\\\\\",\\\\\\\"eventName\\\\\\\":\\\\\\\"autologinFailed\\\\\\\"}{\\\\\\\"errorCode\\\\\\\":\\\\\\\"7\\\\\\\",\\\\\\\"eventName\\\\\\\":\\\\\\\"autologinFailed\\\\\\\"}{\\\\\\\"errorCode\\\\\\\":\\\\\\\"7\\\\\\\",\\\\\\\"eventName\\\\\\\":\\\\\\\"autologinFailed\\\\\\\"}{\\\\\\\"errorCode\\\\\\\":\\\\\\\"7\\\\\\\",\\\\\\\"eventName\\\\\\\":\\\\\\\"autologinFailed\\\\\\\"}{\\\\\\\"errorCode\\\\\\\":\\\\\\\"7\\\\\\\",\\\\\\\"eventName\\\\\\\":\\\\\\\"autologinFailed\\\\\\\"}{\\\\\\\"errorCode\\\\\\\":\\\\\\\"7\\\\\\\",\\\\\\\"eventName\\\\\\\":\\\\\\\"autologinFailed\\\\\\\"}{\\\\\\\"errorCode\\\\\\\":\\\\\\\"7\\\\\\\",\\\\\\\"eventName\\\\\\\":\\\\\\\"autologinFailed\\\\\\\"}\\\",\\\"firstLogin\\\":false,\\\"huaweiLogin\\\":false,\\\"pad\\\":false},\\\"locale\\\":\\\"zh_CN\\\",\\\"sdkVersion\\\":\\\"android_5.3.3.4\\\",\\\"site\\\":25,\\\"t\\\":" + new Date().getTime() + ",\\\"token\\\":\\\"" + token_ + "\\\",\\\"ttid\\\":\\\"1608030065155@eleme_android_11.1.38\\\",\\\"useAcitonType\\\":true,\\\"useDeviceToken\\\":true,\\\"utdid\\\":\\\"\\\"}\",\"riskControlInfo\":\"{\\\"appStore\\\":\\\"1608030065155@eleme_android_11.1.38\\\",\\\"deviceBrand\\\":\\\"Google\\\",\\\"deviceModel\\\":\\\"AOSP on blueline\\\",\\\"deviceName\\\":\\\"AOSP on blueline\\\",\\\"osName\\\":\\\"android\\\",\\\"osVersion\\\":\\\"10\\\",\\\"screenSize\\\":\\\"0x0\\\",\\\"t\\\":\\\"" + new Date().getTime() + "\\\",\\\"umidToken\\\":\\\"" + _0x29f24c + "\\\",\\\"wua\\\":\\\"ISdF_FRG6WfAC3hq3tKFPCpwtmaqmW\\\\/HCzXLk3\\/sCpKM8WVg+0+3t4dsh82tlLh2i1V4g5MRJkbZn4c1EoC0ug92R7WUG0Gqs9+0DsyceK03b7Ckh7UozNrXo4\\\"}\"}";

  let _0x29ce79 = "com.taobao.mtop.mloginunitservice.autologin";
  let _0x556fa1 = "https%3A%2F%2Fr.ele.me%2Fmagic-cube%2F%3FnavType%3D3%26spm%3Da13.b_activity_kb_m71293.0.0%23%2Fgame";

  let _0x28aaa6 = cookieData.get("cookie2");

  let _0xddc3e6 = cookieData.get("unb");

  var _0x3608cd = await _0x3d2823(bd_data, _0x29ce79, _0x556fa1, _0x28aaa6, _0xddc3e6, _0x4b9a0c, _0x53db0c);

  _0x3608cd = JSON.parse(_0x3608cd.msg);

  let _0x22ca46 = encodeURIComponent(_0x3608cd["x-sgext"]);

  let _0x4896ba = encodeURIComponent(_0x3608cd["x-sign"]);

  _0x29f24c = encodeURIComponent(_0x3608cd["x-umt"]);

  let _0x1b7bac = encodeURIComponent(_0x3608cd["x-mini-wua"]);

  let _0x555769 = _0x3608cd["x-t"];

  let _0xbefab0 = encodeURIComponent(_0x3608cd.wua);
  ...
  let _0x5002df = "https://guide-acs.m.taobao.com/gw/com.taobao.mtop.mloginunitservice.autologin/1.0/?data=" + encodeURIComponent(bd_data) + "&type=originaljson&wua=" + _0xbefab0;
  ...
  return _0x3149db(_0x4b73db => {
    _0x509dd2(_0x52003b, async (_0x547cd9, _0x2c530e, _0x27363f) => {
      if (!_0x547cd9 && _0x2c530e.statusCode === 200) {
        try {
          const _0xeda38c = JSON.parse(_0x27363f);

          let _0x34ffff = _0xeda38c.data;

          if (_0x34ffff) {
            if (_0x34ffff.code === 3000) {
              let _0x5e68c6 = JSON.parse(_0x34ffff.returnValue.data);

              const _0x1ac2ea = _0x5e68c6.expires;

              const _0x1b2c07 = new Date(_0x1ac2ea * 1000);

              const _0x28f83d = _0x1b2c07.getFullYear();

              const _0xd1a180 = _0x1b2c07.getMonth() + 1;

              const _0x3757e9 = _0x1b2c07.getDate();

              const _0x472700 = _0x1b2c07.getHours();

              const _0x40a3dd = _0x1b2c07.getMinutes();

              const _0x3e96e0 = _0x1b2c07.getSeconds();

              const _0x45c77a = _0x28f83d + "-" + _0xd1a180 + "-" + _0x3757e9 + " " + _0x472700 + ":" + _0x40a3dd + ":" + _0x3e96e0;

              console.log("刷新成功，ck 失效时间为：" + _0x45c77a);
            } else {
              if (_0x34ffff.message) {
                console.log(_0x34ffff.message);
              } else {
                console.log(_0xeda38c.ret[0]);
              }
            }
          }
...
const _0x3cc857 = {
  "checkCk": _0x384ce0,
  "User_Agent": _0x3f077c,
  "getToken": _0x4e5055,
  "sign": _0xe20ba7,
  "wait": wait,
  "validateCarmeWithType": _0xd8867f,
  "randomString": _0x272806,
  "getCookies": _0x46a23e,
  "getUserInfo": _0x415eb7,
  "validateCarmeNoCon": _0x559415,
  "getCookieMap": _0x3e6c97,
  "invalidCookieNotify": _0x2a292f,
  "checkCarmeCount": _0xe30d85,
  "tryCatchPromise": _0x3149db,
  "checkMasterCk": _0xb95eb1,
  "couponNotify": _0x169936,
  "runOne": _0x5ce2df
};
module.exports = _0x3cc857;