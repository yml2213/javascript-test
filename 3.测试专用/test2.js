 ...
 * 感谢所有测试人员
 * ========= 青龙--配置文件 =========
 * 变量格式: export bhyhkjklb_data='unionId @ unionId'  多个账号用 换行 或 @分割
 * 
...
///////////////////////////////////////////////////////////////////
let ckStr = process.env.bhyhkjklb_data
let msg, ck, ck_status
///////////////////////////////////////////////////////////////////
let VersionCheck = "0.0.1"
let Change = '完成 签到 三次积分抽奖任务 !'
let thank = `\n感谢 Y  的完善修复`
///////////////////////////////////////////////////////////////////
...
async function sign_info(task) {
    let url = {
        url: `https://20315128-3.hdpyqe.com/api/game4JFLY/getSignInRecords?canal=-1&playerOrigin=3&uid=&extra=&aid=20315128&gameId=3&fromIframe=false&_openId=${ck[0]}`,
        headers: {
            'Host': '20315128-3.hdpyqe.com',
            'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8',
        },
...
async function signIn() {
    let url = {
        url: `https://20315128-3.hdpyqe.com/api/game4JFLY/signIn?canal=-1&playerOrigin=3&uid=&extra=&aid=20315128&gameId=3&fromIframe=false&_openId=${ck[0]}`,
        headers: {
            'Host': '20315128-3.hdpyqe.com',
            'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8',
        },
...
/**
 * 获取远程版本
 * http://yml-gitea.ml:2233/yml/JavaScript-yml/raw/branch/master/bhyhkjklb.js
 */
